...
#include "HexCoding.h"
#include "EnergyWebToken/Address.h"
#include "PublicKey.h"
...
using namespace TW;
using namespace TW::EnergyWebToken;

TEST(EnergyWebTokenAddress, Valid) {
    ASSERT_TRUE(Address::isValid("__ADD_VALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(EnergyWebTokenAddress, Invalid) {
    ASSERT_FALSE(Address::isValid("__ADD_INVALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(EnergyWebTokenAddress, FromPrivateKey) {
...
TEST(EnergyWebTokenAddress, FromPublicKey) {
    // TODO: Check public key type, finalize implementation
...
TEST(EnergyWebTokenAddress, FromString) {
